...
<?php
		...
		$query=mysqli_query($con,"SELECT * FROM complaints LEFT JOIN customer ON customer.cid = complaints.customerid")or die(mysqli_error($con));
...
?>
  <?php
        ...
        ?>
          ...
          <?php
          {
          echo '| <a class="btn btn-mini btn-info" href="messageread.php?id='.$id.'">Read</a> ';
          echo '| <a class="btn btn-mini btn-danger" href="messageNotread.php?id='.$id.'">Cancel</a></td>';
          }}
          ?>
        </tr>
