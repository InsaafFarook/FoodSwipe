...
<html>
  <head>
    ...
    <div class="wrapper">
      ...
      <div class="alert alert-info"><center><h2>  Canteen Name   </h2></center></div>
      <br />
  ...
  <label style="font-size:20px;">Food Order Receipt   </label>
    ...
    $t_id = $_GET['tid'];
    $query = $con->query("SELECT * FROM transaction left join customer on transaction.customerid = customer.cid WHERE transaction_id = '$t_id'") or die (mysqli_error());
