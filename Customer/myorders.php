    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Food Request </li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box box-primary">
              <div class="box-header">
                <h3 class="box-title">My Ordered Foods</h3>
              </div>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $cid = $_SESSION['id'];
                    $query = mysqli_query($con, "SELECT * FROM transaction LEFT JOIN customer ON customer.cid = transaction.customerid where  customer.cid='$cid' ") or die(mysqli_error($con));
                    ...
                    ?>
                      ...
                      <tr>
                          ...
                          <td><a href="OnlineInvocie.php?tid=<?php echo $id;
                        } ?>">View</a>
                      </tr>
