...
<div class="wrapper">
  ...
  <div class="form-group">
           ...
           <option value="Administrator"> Administrator </option>
             <option value="salesperson"> Employee </option>
			  <option value="INManager">  Head  </option>
          <option value="SalsManager"> Deputy Head  </option>
			    <option value="salesperson"> Shops </option>
...
?>
		 ...
		 <td><?php echo $row['UserType'];?></td>
					...
					<td><?php echo $row['status'];?></td>	  
                        <td>
				<a href="#updateordinance<?php echo $row['user_id'];?>" data-target="#updateordinance<?php echo $row['user_id'];?>" data-toggle="modal"   class="small-box-footer">Update</a>
