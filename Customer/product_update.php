...
include('../dist/includes/dbcon.php');
	...
	reorder='$reorder',supplier_id='$supplier',cat_id='$category',prod_pic='$pic',serial='$serial',Ex_date='$exdate',prod_desc='$desc' where prod_id='$id'")or die(mysqli_error($con));	
